...
function customerSuccessBalancing(
  ...
  for (const cs of availableCSs) {
    csClientCount[cs.id] = 0;
  }
  ...
  for (const [id, count] of Object.entries(csClientCount)) {
    if (count > maxClients) {
      maxClients = count;
      winnerId = Number(id);
      isTie = false;
